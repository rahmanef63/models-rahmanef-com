...
export const create = internalMutation({
  args: { userId: v.id("users"), workspaceId: v.optional(v.id("workspaces")), task: v.string(), model: v.string(), agentId: v.optional(v.id("agentDefs")), agentName: v.optional(v.string()), at: v.number() },
