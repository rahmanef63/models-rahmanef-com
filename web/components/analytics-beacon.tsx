...
// signed-in console (/app) and non-page routes.

const SESSION_ID_KEY = "models_sid";
const UTM_KEY = "models_utm";
...
const SKIP = ["/app", "/api", "/oauth", "/mcp", "/v1", "/channels", "/invite", "/.well-known"];
