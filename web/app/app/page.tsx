...
type Cred = { provider: string; kind: string; lastCheckedAt?: number; lastCheckedOk?: boolean; lastCheckedCode?: string; lastCheckedDetail?: string };
...
function cheapestModel(catalog: Catalog, provider: string): string | undefined {
...
function ApiKeyForm({ setCredential, testCredential, catalog, isAdmin }: {
...
function ConnectedCreds({ providers, catalog, isAdmin, deleteCredential, testCredential }: {
  providers: Cred[];
  catalog: Catalog;
  isAdmin: boolean;
