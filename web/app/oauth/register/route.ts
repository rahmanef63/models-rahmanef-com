...
export async function POST(req: Request) {
  ...
  try {
    ...
    const r = await client.action(api.mcpOauthNode.registerClient, { name: typeof body.client_name === "string" ? body.client_name : undefined, redirectUris: redirectUris.map(String) });
