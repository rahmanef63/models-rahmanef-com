/**
 * Slice contract for `memory` — v0.1.0. Curated cross-session agent memory. Convex functions
...
export const contract = defineSliceContract({
  ...
  provides: {
    ...
    convex: ["memory.listMemories", "memory.addMemory", "memory.removeMemory", "memory.setMemoryEnabled"],
    tables: ["memories"],
